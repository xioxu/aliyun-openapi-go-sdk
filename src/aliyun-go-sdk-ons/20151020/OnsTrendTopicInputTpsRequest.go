...
func (r *OnsTrendTopicInputTpsRequest) GetQuery() map[string]string {
...
func (r *OnsTrendTopicInputTpsRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *OnsTrendTopicInputTpsRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *OnsTrendTopicInputTpsRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *OnsTrendTopicInputTpsRequest) GetPath() string {
	return ""
}

func (r *OnsTrendTopicInputTpsRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *OnsTrendTopicInputTpsRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *OnsTrendTopicInputTpsRequest) GetActionName() string {
	return "OnsTrendTopicInputTps"
}
