...
func (r *OnsTrendGroupOutputTpsRequest) GetQuery() map[string]string {
...
func (r *OnsTrendGroupOutputTpsRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *OnsTrendGroupOutputTpsRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *OnsTrendGroupOutputTpsRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *OnsTrendGroupOutputTpsRequest) GetPath() string {
	return ""
}

func (r *OnsTrendGroupOutputTpsRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *OnsTrendGroupOutputTpsRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *OnsTrendGroupOutputTpsRequest) GetActionName() string {
	return "OnsTrendGroupOutputTps"
}
