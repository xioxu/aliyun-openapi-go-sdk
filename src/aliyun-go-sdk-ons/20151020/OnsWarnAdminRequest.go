...
func (r *OnsWarnAdminRequest) GetQuery() map[string]string {
...
func (r *OnsWarnAdminRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *OnsWarnAdminRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *OnsWarnAdminRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *OnsWarnAdminRequest) GetPath() string {
	return ""
}

func (r *OnsWarnAdminRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *OnsWarnAdminRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *OnsWarnAdminRequest) GetActionName() string {
	return "OnsWarnAdmin"
}
