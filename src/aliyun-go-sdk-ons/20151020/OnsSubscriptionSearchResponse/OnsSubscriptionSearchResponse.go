...
package ons_OnsSubscriptionSearchResponse
...
type OnsSubscriptionSearchResponse struct {
	Data      []SubscribeInfoDo
	HelpUrl   string
	RequestId string
}

func (m *OnsSubscriptionSearchResponse) BuildProperties(parentKey string, flatObj map[string]interface{}) {

	m.Data = make([]SubscribeInfoDo, 0)
