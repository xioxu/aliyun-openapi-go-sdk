...
func (r *OnsWarnListRequest) GetQuery() map[string]string {
...
func (r *OnsWarnListRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *OnsWarnListRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *OnsWarnListRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *OnsWarnListRequest) GetPath() string {
	return ""
}

func (r *OnsWarnListRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *OnsWarnListRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *OnsWarnListRequest) GetActionName() string {
	return "OnsWarnList"
}
