...
func (r *OnsTrendClusterInputTpsRequest) GetQuery() map[string]string {
...
func (r *OnsTrendClusterInputTpsRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *OnsTrendClusterInputTpsRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *OnsTrendClusterInputTpsRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *OnsTrendClusterInputTpsRequest) GetPath() string {
	return ""
}

func (r *OnsTrendClusterInputTpsRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *OnsTrendClusterInputTpsRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *OnsTrendClusterInputTpsRequest) GetActionName() string {
	return "OnsTrendClusterInputTps"
}
