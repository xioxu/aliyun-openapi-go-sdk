...
func (r *OnsWarnEditorRequest) GetQuery() map[string]string {
...
func (r *OnsWarnEditorRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *OnsWarnEditorRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *OnsWarnEditorRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *OnsWarnEditorRequest) GetPath() string {
	return ""
}

func (r *OnsWarnEditorRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *OnsWarnEditorRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *OnsWarnEditorRequest) GetActionName() string {
	return "OnsWarnEditor"
}
