...
package rds_region_CreatePostpaidDBInstanceForChannelResponse
...
func (m *CreatePostpaidDBInstanceForChannelResponse) BuildProperties(parentKey string, flatObj map[string]interface{}) {
