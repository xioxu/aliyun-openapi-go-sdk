...
func (m *DescribeOptimizeAdviceOnStorageResponse) BuildProperties(parentKey string, flatObj map[string]interface{}) {

	m.Items = make([]AdviceOnStorage, 0)
