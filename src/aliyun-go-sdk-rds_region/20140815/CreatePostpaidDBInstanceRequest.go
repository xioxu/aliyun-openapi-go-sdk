...
func (r *CreatePostpaidDBInstanceRequest) GetQuery() map[string]string {
...
func (r *CreatePostpaidDBInstanceRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *CreatePostpaidDBInstanceRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *CreatePostpaidDBInstanceRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *CreatePostpaidDBInstanceRequest) GetPath() string {
	return ""
}

func (r *CreatePostpaidDBInstanceRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *CreatePostpaidDBInstanceRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *CreatePostpaidDBInstanceRequest) GetActionName() string {
	return "CreatePostpaidDBInstance"
}
