...
package rds_region_DescribeSlowLogRecordsResponse
...
func (m *DescribeSlowLogRecordsResponse) BuildProperties(parentKey string, flatObj map[string]interface{}) {

	m.Items = make([]SQLSlowRecord, 0)
