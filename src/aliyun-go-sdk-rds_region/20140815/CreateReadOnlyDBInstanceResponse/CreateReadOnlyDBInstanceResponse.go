...
package rds_region_CreateReadOnlyDBInstanceResponse
...
func (m *CreateReadOnlyDBInstanceResponse) BuildProperties(parentKey string, flatObj map[string]interface{}) {
