...
package rds_region_DescribeSQLLogRecordsResponse
...
func (m *SQLRecord) BuildProperties(parentKey string, flatObj map[string]interface{}) {
	...
	m.TotalExecutionTimes = builder.GetInt64(parentKey+".TotalExecutionTimes", flatObj)
