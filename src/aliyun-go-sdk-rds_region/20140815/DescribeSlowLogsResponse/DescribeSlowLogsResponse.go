...
package rds_region_DescribeSlowLogsResponse
...
func (m *DescribeSlowLogsResponse) BuildProperties(parentKey string, flatObj map[string]interface{}) {

	m.Items = make([]SQLSlowLog, 0)
