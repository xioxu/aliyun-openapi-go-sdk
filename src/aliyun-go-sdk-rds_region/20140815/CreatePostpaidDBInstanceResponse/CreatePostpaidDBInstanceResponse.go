...
package rds_region_CreatePostpaidDBInstanceResponse
...
func (m *CreatePostpaidDBInstanceResponse) BuildProperties(parentKey string, flatObj map[string]interface{}) {
