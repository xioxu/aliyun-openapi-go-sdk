...
package rds_region_DescribeOptimizeAdviceOnMissPKResponse
...
func (m *DescribeOptimizeAdviceOnMissPKResponse) BuildProperties(parentKey string, flatObj map[string]interface{}) {

	m.Items = make([]AdviceOnMissPK, 0)
