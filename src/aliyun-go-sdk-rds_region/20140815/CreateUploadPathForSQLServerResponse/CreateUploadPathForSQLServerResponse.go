...
package rds_region_CreateUploadPathForSQLServerResponse
...
func (m *CreateUploadPathForSQLServerResponse) BuildProperties(parentKey string, flatObj map[string]interface{}) {
