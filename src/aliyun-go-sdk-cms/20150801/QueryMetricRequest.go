...
func (r *QueryMetricRequest) GetQuery() map[string]string {
...
func (r *QueryMetricRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *QueryMetricRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *QueryMetricRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *QueryMetricRequest) GetPath() string {
	return ""
}

func (r *QueryMetricRequest) GetRequestMethod() string {
	return "GET"
}

func (r *QueryMetricRequest) GetProtocol() string {
	return "HTTP"
}

func (r *QueryMetricRequest) GetActionName() string {
	return "QueryMetric"
}
