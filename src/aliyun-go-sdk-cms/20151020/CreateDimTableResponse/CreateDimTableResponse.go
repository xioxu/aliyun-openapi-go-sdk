...
package cms_CreateDimTableResponse
...
func (m *CreateDimTableResponse) BuildProperties(parentKey string, flatObj map[string]interface{}) {
	...
	m.Result = builder.GetInt64(parentKey+".Result", flatObj)
