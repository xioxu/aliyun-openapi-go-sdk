...
package cms_DescribeMetricDatumResponse
...
func (m *DescribeMetricDatumResponse) BuildProperties(parentKey string, flatObj map[string]interface{}) {
	...
	m.NextToken = builder.GetInt32(parentKey+".NextToken", flatObj)
