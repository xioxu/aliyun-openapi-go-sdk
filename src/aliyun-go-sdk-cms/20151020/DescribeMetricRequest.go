...
func (r *DescribeMetricRequest) GetQuery() map[string]string {
...
func (r *DescribeMetricRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *DescribeMetricRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *DescribeMetricRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *DescribeMetricRequest) GetPath() string {
	return ""
}

func (r *DescribeMetricRequest) GetRequestMethod() string {
	return "GET"
}

func (r *DescribeMetricRequest) GetProtocol() string {
	return "HTTP"
}

func (r *DescribeMetricRequest) GetActionName() string {
