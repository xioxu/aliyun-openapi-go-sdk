...
func (r *QueryStatisticsRequest) GetQuery() map[string]string {
	...
	core.AddToMapIfNotDefaultValueStr(queryVals, "Function", r.Function)
	core.AddToMapIfNotDefaultValueStr(queryVals, "Extend", r.Extend)

	return queryVals
}

func (r *QueryStatisticsRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *QueryStatisticsRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *QueryStatisticsRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *QueryStatisticsRequest) GetPath() string {
	return ""
}

func (r *QueryStatisticsRequest) GetRequestMethod() string {
	return "GET"
}

func (r *QueryStatisticsRequest) GetProtocol() string {
	return "HTTP"
}

func (r *QueryStatisticsRequest) GetActionName() string {
