...
package kvstore_DescribeInstancesResponse
...
func (m *KVStoreInstance) BuildProperties(parentKey string, flatObj map[string]interface{}) {
	...
	m.Port = builder.GetInt64(parentKey+".Port", flatObj)
