...
func (r *DescribeResourceByTagsRequest) GetQuery() map[string]string {
...
func (r *DescribeResourceByTagsRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *DescribeResourceByTagsRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *DescribeResourceByTagsRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *DescribeResourceByTagsRequest) GetPath() string {
	return ""
}

func (r *DescribeResourceByTagsRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *DescribeResourceByTagsRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *DescribeResourceByTagsRequest) GetActionName() string {
	return "DescribeResourceByTags"
}
