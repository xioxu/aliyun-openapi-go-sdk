...
func (m *RouteEntry) BuildProperties(parentKey string, flatObj map[string]interface{}) {

	m.RouteTableId = builder.GetString(parentKey+".RouteTableId", flatObj)

	m.DestinationCidrBlock = builder.GetString(parentKey+".DestinationCidrBlock", flatObj)
	...
	m.NextHopType = builder.GetString(parentKey+".NextHopType", flatObj)
