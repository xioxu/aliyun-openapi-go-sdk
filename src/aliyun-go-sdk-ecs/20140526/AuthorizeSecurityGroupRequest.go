...
func (r *AuthorizeSecurityGroupRequest) GetQuery() map[string]string {
...
func (r *AuthorizeSecurityGroupRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *AuthorizeSecurityGroupRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *AuthorizeSecurityGroupRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *AuthorizeSecurityGroupRequest) GetPath() string {
	return ""
}

func (r *AuthorizeSecurityGroupRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *AuthorizeSecurityGroupRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *AuthorizeSecurityGroupRequest) GetActionName() string {
