...
func (r *RemoveTagsRequest) GetQuery() map[string]string {
...
func (r *RemoveTagsRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *RemoveTagsRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *RemoveTagsRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *RemoveTagsRequest) GetPath() string {
	return ""
}

func (r *RemoveTagsRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *RemoveTagsRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *RemoveTagsRequest) GetActionName() string {
	return "RemoveTags"
}
