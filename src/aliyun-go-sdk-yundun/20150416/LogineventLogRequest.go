...
func (r *LogineventLogRequest) GetQuery() map[string]string {
...
func (r *LogineventLogRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *LogineventLogRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *LogineventLogRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *LogineventLogRequest) GetPath() string {
	return ""
}

func (r *LogineventLogRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *LogineventLogRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *LogineventLogRequest) GetActionName() string {
