...
func (r *BruteforceLogRequest) GetQuery() map[string]string {
...
func (r *BruteforceLogRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *BruteforceLogRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *BruteforceLogRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *BruteforceLogRequest) GetPath() string {
	return ""
}

func (r *BruteforceLogRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *BruteforceLogRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *BruteforceLogRequest) GetActionName() string {
