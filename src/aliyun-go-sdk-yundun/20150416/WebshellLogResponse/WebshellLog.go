...
package yundun_WebshellLogResponse
...
func (m *WebshellLog) BuildProperties(parentKey string, flatObj map[string]interface{}) {

	m.Id = builder.GetString(parentKey+".Id", flatObj)

	m.Path = builder.GetString(parentKey+".Path", flatObj)
