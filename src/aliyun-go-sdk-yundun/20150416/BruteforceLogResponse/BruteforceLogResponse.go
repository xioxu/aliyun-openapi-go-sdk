...
package yundun_BruteforceLogResponse
...
func (m *BruteforceLogResponse) BuildProperties(parentKey string, flatObj map[string]interface{}) {

	m.LogList = make([]BruteforceLog, 0)
