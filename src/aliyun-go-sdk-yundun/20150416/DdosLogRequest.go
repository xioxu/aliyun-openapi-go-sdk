...
func (r *DdosLogRequest) GetQuery() map[string]string {
...
func (r *DdosLogRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *DdosLogRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *DdosLogRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *DdosLogRequest) GetPath() string {
	return ""
}

func (r *DdosLogRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *DdosLogRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *DdosLogRequest) GetActionName() string {
	return "DdosLog"
}
