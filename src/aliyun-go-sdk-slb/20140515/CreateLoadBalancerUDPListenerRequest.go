...
func (r *CreateLoadBalancerUDPListenerRequest) GetQuery() map[string]string {
...
func (r *CreateLoadBalancerUDPListenerRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *CreateLoadBalancerUDPListenerRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *CreateLoadBalancerUDPListenerRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *CreateLoadBalancerUDPListenerRequest) GetPath() string {
	return ""
}

func (r *CreateLoadBalancerUDPListenerRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *CreateLoadBalancerUDPListenerRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *CreateLoadBalancerUDPListenerRequest) GetActionName() string {
	return "CreateLoadBalancerUDPListener"
}
