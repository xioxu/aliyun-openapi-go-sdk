...
package slb_DescribeLoadBalancerHTTPSListenerAttributeResponse
...
func (m *DescribeLoadBalancerHTTPSListenerAttributeResponse) BuildProperties(parentKey string, flatObj map[string]interface{}) {
