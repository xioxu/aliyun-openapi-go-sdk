...
func (m *ListenerPortAndProtocal) BuildProperties(parentKey string, flatObj map[string]interface{}) {

	m.ListenerPort = builder.GetInt32(parentKey+".ListenerPort", flatObj)

	m.ListenerProtocal = builder.GetString(parentKey+".ListenerProtocal", flatObj)
