...
package alert_ListNotifyHistoryResponse
...
func (m *ListNotifyHistoryResponse) BuildProperties(parentKey string, flatObj map[string]interface{}) {
	...
	m.datapoints = builder.GetString(parentKey+".datapoints", flatObj)

	m.total = builder.GetString(parentKey+".total", flatObj)
