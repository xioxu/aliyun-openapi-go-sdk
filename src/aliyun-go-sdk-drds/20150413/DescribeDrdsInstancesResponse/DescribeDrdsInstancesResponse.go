...
package drds_DescribeDrdsInstancesResponse
...
func (m *DescribeDrdsInstancesResponse) BuildProperties(parentKey string, flatObj map[string]interface{}) {

	m.Data = make([]Instance, 0)
