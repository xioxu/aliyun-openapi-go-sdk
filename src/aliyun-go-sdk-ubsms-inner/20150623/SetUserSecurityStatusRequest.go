...
func (r *SetUserSecurityStatusRequest) GetQuery() map[string]string {
...
func (r *SetUserSecurityStatusRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *SetUserSecurityStatusRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *SetUserSecurityStatusRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *SetUserSecurityStatusRequest) GetPath() string {
	return ""
}

func (r *SetUserSecurityStatusRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *SetUserSecurityStatusRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *SetUserSecurityStatusRequest) GetActionName() string {
	return "SetUserSecurityStatus"
}
