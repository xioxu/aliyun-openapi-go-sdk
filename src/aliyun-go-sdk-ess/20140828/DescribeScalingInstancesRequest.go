...
func (r *DescribeScalingInstancesRequest) GetQuery() map[string]string {
	var queryVals = make(map[string]string, 31)
	...
	core.AddToMapIfNotDefaultValueStr(queryVals, "HealthStatus", r.HealthStatus)
	core.AddToMapIfNotDefaultValueStr(queryVals, "LifecycleState", r.LifecycleState)
	core.AddToMapIfNotDefaultValueStr(queryVals, "CreationType", r.CreationType)
...
func (r *DescribeScalingInstancesRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *DescribeScalingInstancesRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *DescribeScalingInstancesRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *DescribeScalingInstancesRequest) GetPath() string {
	return ""
}

func (r *DescribeScalingInstancesRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *DescribeScalingInstancesRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *DescribeScalingInstancesRequest) GetActionName() string {
	return "DescribeScalingInstances"
}
