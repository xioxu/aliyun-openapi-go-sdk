...
func (r *EnableScalingGroupRequest) GetQuery() map[string]string {
	var queryVals = make(map[string]string, 26)
...
func (r *EnableScalingGroupRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *EnableScalingGroupRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *EnableScalingGroupRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *EnableScalingGroupRequest) GetPath() string {
	return ""
}

func (r *EnableScalingGroupRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *EnableScalingGroupRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *EnableScalingGroupRequest) GetActionName() string {
	return "EnableScalingGroup"
}
