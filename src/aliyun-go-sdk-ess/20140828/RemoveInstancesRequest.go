...
func (r *RemoveInstancesRequest) GetQuery() map[string]string {
...
func (r *RemoveInstancesRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *RemoveInstancesRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *RemoveInstancesRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *RemoveInstancesRequest) GetPath() string {
	return ""
}

func (r *RemoveInstancesRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *RemoveInstancesRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *RemoveInstancesRequest) GetActionName() string {
