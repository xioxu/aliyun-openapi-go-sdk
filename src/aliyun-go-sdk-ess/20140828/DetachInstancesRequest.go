...
func (r *DetachInstancesRequest) GetQuery() map[string]string {
...
func (r *DetachInstancesRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *DetachInstancesRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *DetachInstancesRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *DetachInstancesRequest) GetPath() string {
	return ""
}

func (r *DetachInstancesRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *DetachInstancesRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *DetachInstancesRequest) GetActionName() string {
