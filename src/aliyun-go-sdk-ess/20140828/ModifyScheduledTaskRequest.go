...
func (r *ModifyScheduledTaskRequest) GetQuery() map[string]string {
...
func (r *ModifyScheduledTaskRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *ModifyScheduledTaskRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *ModifyScheduledTaskRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *ModifyScheduledTaskRequest) GetPath() string {
	return ""
}

func (r *ModifyScheduledTaskRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *ModifyScheduledTaskRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *ModifyScheduledTaskRequest) GetActionName() string {
	return "ModifyScheduledTask"
}
