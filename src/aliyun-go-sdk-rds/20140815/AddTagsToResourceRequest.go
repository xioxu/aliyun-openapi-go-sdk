...
func (r *AddTagsToResourceRequest) GetQuery() map[string]string {
...
func (r *AddTagsToResourceRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *AddTagsToResourceRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *AddTagsToResourceRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *AddTagsToResourceRequest) GetPath() string {
	return ""
}

func (r *AddTagsToResourceRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *AddTagsToResourceRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *AddTagsToResourceRequest) GetActionName() string {
