...
package rds_DescribeDBInstancesResponse
...
func (m *DescribeDBInstancesResponse) BuildProperties(parentKey string, flatObj map[string]interface{}) {

	m.Items = make([]DBInstance, 0)
