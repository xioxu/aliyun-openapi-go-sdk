...
func (r *DescibeImportsFromDatabaseRequest) GetQuery() map[string]string {
...
func (r *DescibeImportsFromDatabaseRequest) GetBody() map[string]string {
	var bodyVals = make(map[string]string, 0)

	return bodyVals
}

func (r *DescibeImportsFromDatabaseRequest) GetHeaders() map[string]string {
	var headerVals = make(map[string]string, 0)

	return headerVals
}

func (r *DescibeImportsFromDatabaseRequest) GetDomainValues() map[string]string {
	var domainVals = make(map[string]string, 0)

	return domainVals
}

func (r *DescibeImportsFromDatabaseRequest) GetPath() string {
	return ""
}

func (r *DescibeImportsFromDatabaseRequest) GetRequestMethod() string {
	return "POST|GET"
}

func (r *DescibeImportsFromDatabaseRequest) GetProtocol() string {
	return "HTTP|HTTPS"
}

func (r *DescibeImportsFromDatabaseRequest) GetActionName() string {
	return "DescibeImportsFromDatabase"
}
