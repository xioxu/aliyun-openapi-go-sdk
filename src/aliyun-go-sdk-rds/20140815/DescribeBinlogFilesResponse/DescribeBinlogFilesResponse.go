...
package rds_DescribeBinlogFilesResponse
...
func (m *DescribeBinlogFilesResponse) BuildProperties(parentKey string, flatObj map[string]interface{}) {

	m.Items = make([]BinLogFile, 0)
